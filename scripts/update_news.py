...
PROMPT = (
    "Sei un curatore esperto di IA. Cerca sul web le novità più importanti "
    "del mondo dell'intelligenza artificiale dell'ultimo mese (modelli nuovi, "
    "paper rilevanti, prodotti, regolamentazione, ricerca). "
    "Scrivi un riassunto IN ITALIANO per una studentessa di 18 anni che vuole "
    "diventare elite nell'IA. Produci ESATTAMENTE 5 punti, ognuno una frase "
    "chiara con il perché conta. "
    "Restituisci SOLO frammento HTML in questo formato, senza altro testo:\n"
    "<ul style=\"margin:0; padding-left:1.2rem;\">\n"
    "<li style=\"margin-bottom:8px;\"><b>Titolo</b> — spiegazione e perché conta.</li>\n"
    "... (5 voci)\n"
    "</ul>"
)
